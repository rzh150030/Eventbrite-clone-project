...
module.exports = {
  up: (queryInterface, Sequelize) => {
      return queryInterface.bulkInsert('Career_fairs', [
        {host_id: 3, venue_id: 2, name: "MacroHard Career Meetup 2021", date: new Date("August 7, 2021 2:00 PM"), capacity: 100},
        ...
        {host_id: 3, venue_id: 2, name: "MacroHard Career Meetup 2022", date: new Date("August 7, 2022 2:00 PM"), capacity: 100}
      ], {});
